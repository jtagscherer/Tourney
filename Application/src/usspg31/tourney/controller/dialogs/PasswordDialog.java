...
public class PasswordDialog extends VBox implements IModalDialogProvider<Object, Object> {
    ...
    public PasswordDialog() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    this.getClass().getResource("/ui/fxml/dialogs/password-dialog.fxml"),
        ...
        this.retryIn.addListener((ov, o, n) -> {
            if (n.intValue() == 0) {
                ...
                this.buttonUnlock.setText(PreferencesManager.getInstance()
                        .localizeString("dialogs.password.unlock"));
            } else {
                if (!this.buttonUnlock.textProperty().isBound()) {
                    this.buttonUnlock.setDisable(true);
                    this.buttonUnlock.textProperty().bind(
