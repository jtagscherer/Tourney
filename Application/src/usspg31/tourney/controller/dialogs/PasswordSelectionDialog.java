...
public class PasswordSelectionDialog extends VBox implements IModalDialogProvider<Object, Object> {

    private static final Logger log = Logger.getLogger(PasswordSelectionDialog.class.getName());
    ...
    @FXML private PasswordField passwordFieldCurrent;
    @FXML private PasswordField passwordFieldNew;
    @FXML private PasswordField passwordFieldNewRepeat;
    ...
    public PasswordSelectionDialog() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    this.getClass().getResource("/ui/fxml/dialogs/password-selection-dialog.fxml"),
        ...
        this.retryIn.addListener((ov, o, n) -> {
            if (n.intValue() == 0) {
        ...
        this.retryTimer = new Timeline(new KeyFrame(Duration.seconds(1), event -> {
