...
\begin{tabularx}{\textwidth}{| p{0.2\textwidth} | p{0.7415\textwidth} |}
	...
	\textbf{ID} & 1 \\
	\hline
	\textbf{Ziel} & Das Event ist mit allen notwendigen Daten fertig erstellt und es kann mit der Voranmeldung begonnen werden \\
	\hline
	...
	\begin{itemize}
		...
		\item Anwendung wurde falls nötig entsperrt
	\end{itemize} \\
	\hline
	\textbf{Ablauf} &
		\begin{enumerate}
...
\begin{tabularx}{\textwidth}{| p{0.2\textwidth} | p{0.7415\textwidth} |}
	...
	\textbf{Vorbedingung} &
	\begin{itemize}
		\item Tourney ist geöffnet
		\item Der Nutzer befindet sich auf der Startseite oder beim Erstellen eines Events in der Phase, in der die Turniere hinzugefügt werden
	\end{itemize} \\
	\hline
	\textbf{Ablauf} &
		\begin{enumerate}
