...
Die folgenden vier Fenster können erreicht werden, wenn ein neues Turnier erstellt oder ein vorhandenes bearbeitet oder durchgeführt werden soll. Die Fenster haben eine Reihe Knöpfen am oberen Rand gemein, die von links nach rechts die folgenden Funktionen ausführen:
\begin{itemize}
...
In der Durchführung eines einzelnen Turniers können stattfindende Paarungen angezeigt werden und mit den Knöpfen auf der rechten Seite diese verändert und Ergebnisse eingetragen werden.
